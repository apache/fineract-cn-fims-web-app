...
export const LOAD_ALL = type('[Group Command] Load All');
export const LOAD_ALL_COMPLETE = type('[Group Command] Load All Complete');
...
export class LoadAllCompleteAction implements Action {
  ...
  constructor(public payload: GroupCommand[]) { }
}
